...
def exterior():
    ...
    shedwall1.node().addSolid(CollisionCapsule(115,-14,1.5, 135,-22,1.5, 1))
    shedwall2 = base.scene.attachNewNode(CollisionNode('shedwall2'))
    shedwall2.node().addSolid(CollisionCapsule(135,-22,1.5, 143.2,1.2,1.5, 1))
    shedwall3 = base.scene.attachNewNode(CollisionNode('shedwall3'))
    shedwall3.node().addSolid(CollisionCapsule(143.2,1.2,1.5, 123,8.5,1.5, 1))
    shedwall4 = base.scene.attachNewNode(CollisionNode('shedwall4'))
    shedwall4.node().addSolid(CollisionCapsule(123,8.5,1.5, 119.8,-0.3,1.5, 1))
    shedwall5 = base.scene.attachNewNode(CollisionNode('shedwall5'))
    shedwall5.node().addSolid(CollisionCapsule(117.2,-7.6,1.5, 115,-14,1.5, 1))
    generator = base.scene.attachNewNode(CollisionNode('generator'))
    generator.node().addSolid(CollisionCapsule(129.8,-6.8,0.5, 136,-9,0.5, 3))
    shedstuff = base.scene.attachNewNode(CollisionNode('shedstuff'))
    shedstuff.node().addSolid(CollisionCapsule(140,1,1, 124,6.5,1, 1.2))
    shedstuff2 = base.scene.attachNewNode(CollisionNode('shedstuff2'))
    shedstuff2.node().addSolid(CollisionCapsule(140,0,1, 140,-4.2,1, 1.2))
    shedbox = base.scene.attachNewNode(CollisionNode('shedbox'))
    shedbox.node().addSolid(CollisionSphere(133.5,-19.5,1,2))
    shedshelves = base.scene.attachNewNode(CollisionNode('shedshelves'))
    shedshelves.node().addSolid(CollisionCapsule(126,-17,1, 116,-13,1, 1))
